...
<body class="w3-theme-l5" background="img/21.jpg">

<!-- Whatsapp -->
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
<a href="https://api.whatsapp.com/send?phone=59174532656&text=Hola%20sean%20bienvenidos%20!" class="float" target="_blank">
  ...
  <div class="w3-row">
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card-8 w3-dark-grey">
        <div class="w3-container">
         ...
         <p class="w3-container"><img src="img/22.jpg" class="w3-circle" style="height:106px;width:106px" alt="Avatar"></p>
         <h5 class="w3-center">JULIANA CARDENAS</h5>
      ...
      <br>
        ...
        <button onclick="myFunction('Demo1')" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-user fa-fw w3-margin-right"></i><a href="{{route("articles.index")}}">Productos</a> </button>
        <div id="Demo1" class="w3-hide w3-container">
            <p>Some text..</p>
        </div>
        ...
        <div id="Demo2" class="w3-hide w3-container">
         ...
         <div class="w3-row-padding">
            ...
            <button onclick="myFunction('Demo4')" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-user fa-fw w3-margin-right"></i><a href="{{route("clients.index")}}">Clientes</a> </button>
    ...
    <div class="w3-col m7">
        ...
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
              <h4 class="w3-opacity w3-center"><b>Productos</b></h4>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class=" w3-container w3-card w3-white w3-round w3-margin"><br>
        <h4 class="w3-center">Productos</h4>
        <hr class="w3-clear">
    ...
    <div class="w3-col m2">
      ...
      <div class="w3-dropdown-hover">
        <img src="img/2.jpg" alt="Norway" style="width:20%">
